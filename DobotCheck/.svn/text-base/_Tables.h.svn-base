...
// _Tables wrapper class

class _Tables : public COleDispatchDriver
{
public:
	_Tables(){} // Calls COleDispatchDriver default constructor
	_Tables(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_Tables(const _Tables& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
