...
// _Documents wrapper class

class _Documents : public COleDispatchDriver
{
public:
	_Documents(){} // Calls COleDispatchDriver default constructor
	_Documents(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_Documents(const _Documents& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
