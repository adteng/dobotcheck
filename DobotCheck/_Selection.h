...
// _Selection wrapper class

class _Selection : public COleDispatchDriver
{
public:
	_Selection(){} // Calls COleDispatchDriver default constructor
	_Selection(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	_Selection(const _Selection& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
